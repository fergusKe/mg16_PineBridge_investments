// JavaScript Document
var FBapi = {};
FBapi.host_name = "https://event.ad.megais.com/nescafe/NESCAFE_gold/";
FBapi.app_id = "1214620748600533";
FBapi.scope = "email";
(function($, FBapi){
    ...
    //ui分享
    FBapi.fbUIShare = function(pObj, callback){
        pObj = pObj || {};
        ...
        if(Fun.detectmobile.isMobile) sendObj.display= "popup";
    ...
    FBapi.setCanvasSize = function(pObj) {
        pObj = pObj || {};
        FB.Canvas.setSize(pObj);
    }
